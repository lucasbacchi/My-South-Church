    ...
    return (
        <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <div className="bg-linear-to-br from-primary/10 to-accent/10 border border-primary/20 rounded-xl p-6 sm:p-8 shadow-md">
                <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-2">Shared Files</h2>
                <p className="text-sm sm:text-base text-foreground/70 mb-4">
                    Access files shared with your ministries and teams. Find what you need quickly and easily.
                </p>
            ...
            <div className="bg-card border border-border rounded-xl p-8 sm:p-12 text-center">
                ...
                <p className="text-base sm:text-lg text-muted-foreground">Loading your files...</p>
            </div>
        </div>
    );
}
